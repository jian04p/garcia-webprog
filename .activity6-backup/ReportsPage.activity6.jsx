        ...
        <Card>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              This chart compares how many reports were generated and how many were
              completed across the last four months.
            </Typography>
            <BarChart
              series={[
        ...
        <Stack direction={{ xs: 'column', lg: 'row' }} spacing={3}>
          <Card sx={{ flex: 1 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                This chart shows the distribution of report requests by category for
          ...
          <Card sx={{ flex: 1 }}>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                ...
                based on the latest reporting cycle.
              </Typography>
